...
public class NewCrypt
{
	...
	public void decryptMe(byte[] raw) throws IOException
	{
	...
	public void decrypt(byte[] raw, final int offset, final int size) throws IOException
	{
		...
		for (int i = 0; i < count; i++)
		{
			_decrypt.processBlock(raw, offset + i * 8, raw, offset + i * 8);
		}
	}

	public void cryptMe(byte[] raw) throws IOException
	{
		int count = raw.length / 8;
		for (int i = 0; i < count;i++)
		{
	...
	public void crypt(byte[] raw, final int offset, final int size) throws IOException
	{
		...
		for (int i = 0; i < count; i++)
		{
			_crypt.processBlock(raw, offset + i * 8, raw, offset + i * 8);
		}
	}
}
