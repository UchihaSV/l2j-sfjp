...
public class MinionList
{
	...
	public void onMasterSpawn()
	{
		...
		if ((_reusedMinionReferences == null) && (_master.getTemplate().getParameters().getSet().get("SummonPrivateRate") == null) && _master.getTemplate().getParameters().getMinionList("Privates").length != 0 && (_master.getSpawn() != null) && _master.getSpawn().isRespawnEnabled())
		{
