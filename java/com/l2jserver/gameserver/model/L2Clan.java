...
public class L2Clan implements IIdentifiable, INamable
{
	...
	private final FastIntObjectMap<Skill> _skills = new FastIntObjectMap<>();
	...
	private final FastIntObjectMap<Skill> _subPledgeSkills = new FastIntObjectMap<>();
	 ...
	 */
	public FastIntObjectMap<Skill> getSkills()
	{
		return _skills;
	}
	...
	public void initializePrivs()
	{
		for (int i = 1; i < 10; i++)
		{
			RankPrivs privs = new RankPrivs(i, 0, new EnumIntBitmask<>(ClanPrivilege.class, false));
			_privs.put(i, privs);
		}
	}
