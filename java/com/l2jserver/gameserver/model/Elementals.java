...
public final class Elementals
{
	...
	public static byte getElementId(String name)
	{
		...
		if (tmp.equals("fire") || tmp.equals("âŒ"))
			return FIRE;
		if (tmp.equals("water") || tmp.equals("êÖ"))
			return WATER;
		if (tmp.equals("wind") || tmp.equals("ïó"))
			return WIND;
		if (tmp.equals("earth") || tmp.equals("ín"))
			return EARTH;
		if (tmp.equals("dark") || tmp.equals("à≈"))
			return DARK;
		if (tmp.equals("holy") || tmp.equals("êπ"))
			return HOLY;
		return NONE;
	}
