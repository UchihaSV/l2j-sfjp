...
public class L2NpcInstance extends L2Npc
{
	...
	public static void showSkillList(L2PcInstance player, L2Npc npc, ClassId classId)
	{
		...
		if (((L2NpcInstance) npc).getClassesToTeach().isEmpty())
		{
			...
			final String sb = StringUtil.concat("<html><body>I cannot teach you. My class list is empty.<br>Ask admin to fix it. Need add my npcid and classes to skillLearn.xml.<br>NpcId:", String.valueOf(npcId), ", Your classId:", String.valueOf(player.getClassId().getId()), "</body></html>");
			html.setHtml(sb);
