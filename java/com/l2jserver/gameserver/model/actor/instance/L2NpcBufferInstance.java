...
public class L2NpcBufferInstance extends L2Npc
{
	...
	public void showChatWindow(L2PcInstance playerInstance, int val)
	{
		...
		String htmContent = HtmCache.getInstance().getHtm(playerInstance.getHtmlPrefix()
				, val > 0 ? "data/html/mods/NpcBuffer-" + val + ".htm"
		...
		else if (command.startsWith("Buff") || command.startsWith("PetBuff"))
		{
			...
			for (String buffGroupList : buffGroupArray)
			{
				...
				if (skillFeeId != 0)
				{
					...
					{
						//[JOJO]-------------------------------------------------
						if (skillFeeId == com.l2jserver.gameserver.model.itemcontainer.PcInventory.ADENA_ID)
						{
