...
public class L2CastleChamberlainInstance extends L2MerchantInstance
{
		...
		else if (condition == COND_OWNER)
		{
			...
			else if (actualCommand.equalsIgnoreCase("receive_report"))
			{
				if (player.isClanLeader())
				{
					...
					html.replace("%castlename%", getCastle().getCastleNameHtm());	//[JOJO]
					
					html.replace("%ss_event%", SevenSigns.getInstance().getCurrentPeriodName());	//[JOJO]
				...
				//			break;
				//	}
					html.replace("%ss_avarice%", SevenSigns.getCabalNameJA(SevenSigns.getInstance().getSealOwner(SevenSigns.SEAL_AVARICE)));	//[JOJO]
					html.replace("%ss_gnosis%" , SevenSigns.getCabalNameJA(SevenSigns.getInstance().getSealOwner(SevenSigns.SEAL_GNOSIS)));		//[JOJO]
					html.replace("%ss_strife%" , SevenSigns.getCabalNameJA(SevenSigns.getInstance().getSealOwner(SevenSigns.SEAL_STRIFE)));		//[JOJO]
			...
			else if (actualCommand.equalsIgnoreCase("functions"))
			{
				...
				else
				{
					...
					{
						html.replace("%xp_regen%", getCastle().getFunction(Castle.FUNC_RESTORE_EXP).getLvl());
					}
					else
					{
					...
					{
						html.replace("%hp_regen%", getCastle().getFunction(Castle.FUNC_RESTORE_HP).getLvl());
					}
					else
					{
					...
					{
						html.replace("%mp_regen%", getCastle().getFunction(Castle.FUNC_RESTORE_MP).getLvl());
					}
					else
					{
					...
					if (val.equalsIgnoreCase("recovery"))
					{
						if (st.countTokens() >= 1)
						{
							...
							else if (val.equalsIgnoreCase("edit_hp"))
							{
								...
								html.replace("%cost%", cost + "</font>Adena /" + (Config.CS_HPREG_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_mp"))
							{
								...
								html.replace("%cost%", cost + "</font>Adena /" + (Config.CS_MPREG_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_exp"))
							{
								...
								html.replace("%cost%", cost + "</font>Adena /" + (Config.CS_EXPREG_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
						...
						if (getCastle().getFunction(Castle.FUNC_RESTORE_HP) != null)
						{
							html.replace("%hp_recovery%", getCastle().getFunction(Castle.FUNC_RESTORE_HP).getLvl() + "%</font> (<font color=\"FFAABB\">" + getCastle().getFunction(Castle.FUNC_RESTORE_HP).getLease() + "</font>Adena /" + (Config.CS_HPREG_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day)");
						...
						if (getCastle().getFunction(Castle.FUNC_RESTORE_EXP) != null)
						{
							html.replace("%exp_recovery%", getCastle().getFunction(Castle.FUNC_RESTORE_EXP).getLvl() + "%</font> (<font color=\"FFAABB\">" + getCastle().getFunction(Castle.FUNC_RESTORE_EXP).getLease() + "</font>Adena /" + (Config.CS_EXPREG_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day)");
						...
						if (getCastle().getFunction(Castle.FUNC_RESTORE_MP) != null)
						{
							html.replace("%mp_recovery%", getCastle().getFunction(Castle.FUNC_RESTORE_MP).getLvl() + "%</font> (<font color=\"FFAABB\">" + getCastle().getFunction(Castle.FUNC_RESTORE_MP).getLease() + "</font>Adena /" + (Config.CS_MPREG_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day)");
					...
					else if (val.equalsIgnoreCase("other"))
					{
						if (st.countTokens() >= 1)
						{
							...
							else if (val.equalsIgnoreCase("edit_support"))
							{
								...
								html.replace("%cost%", cost + "</font>Adena /" + (Config.CS_SUPPORT_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_tele"))
							{
								...
								html.replace("%cost%", cost + "</font>Adena /" + (Config.CS_TELE_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
						...
						if (getCastle().getFunction(Castle.FUNC_TELEPORT) != null)
						{
							html.replace("%tele%", "Stage " + getCastle().getFunction(Castle.FUNC_TELEPORT).getLvl() + "</font> (<font color=\"FFAABB\">" + getCastle().getFunction(Castle.FUNC_TELEPORT).getLease() + "</font>Adena /" + (Config.CS_TELE_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day)");
						...
						if (getCastle().getFunction(Castle.FUNC_SUPPORT) != null)
						{
							html.replace("%support%", "Stage " + getCastle().getFunction(Castle.FUNC_SUPPORT).getLvl() + "</font> (<font color=\"FFAABB\">" + getCastle().getFunction(Castle.FUNC_SUPPORT).getLease() + "</font>Adena /" + (Config.CS_SUPPORT_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day)");
			...
			else if (actualCommand.equalsIgnoreCase("siege_change")) // siege day set
			{
				...
				else if (player.isClanLeader())
				{
					...
					else
					{
						...
						html.replace("%time%", dateFormat(getCastle().getSiegeDate().getTime()));
						sendHtmlMessage(player, html);
					}
				}
				else
	...
	{
		return getHtmlPath("data/html/chamberlain/", npcId, val);
	}
