...
if (com.l2jserver.Config.INITIALIZE_EMPTY_COLLECTION) {{
	...
	public final int getAbnormalEffects() //+[JOJO]
	{
							...
							else if (target.isL2Attackable())
							{
								switch (skill.getSkillType())
								{
									...
									case UNLOCK_SPECIAL:
										break;
									//[JOJO]-------------------------------------------------
									case BEAST_RELEASE:		// ONE  8362 ñ“èbåPó˚ÅFâÇ´ï˙Ç¬ - ñ“èbÇ1ì™ï˙ÇøÇ‹Ç∑ÅB
									case BEAST_ACCOMPANY:	// ONE  8363 ñ“èbåPó˚ÅFÇ¬Ç¢ÇƒóàÇÈ - ñ“èbÇ…Ç¬Ç¢ÇƒóàÇÈÇÊÇ§ñΩóﬂÇµÇ‹Ç∑ÅB
									case BEAST_SKILL:		// ONE  8364 ñ“èbåPó˚ÅFì¡éÍî\óÕégóp - ñ“èbÇ…ì¡éÍî\óÕÇégÇ§ÇÊÇ§ñΩóﬂÇµÇ‹Ç∑ÅB
								//	case BEAST_RELEASE_ALL:	// SELF 8378 ñ“èbåPó˚ÅFÇ∑Ç◊ÇƒâÇ´ï˙Ç¬ - ñ“èbÇÇ∑Ç◊Çƒï˙ÇøÇ‹Ç∑ÅB
if (com.l2jserver.Config.NEVER_TARGET_TAMED) {{
	...
	{
		return false;	//[JOJO] L2Chracter Ç©ÇÁ l2pcInstance Ç÷à¯âzÇµ.
	}
