...
public class StatsSet
{
	...
	public String getString(String name)
	{
		...
		if (val == null)
		{
			throw new IllegalArgumentException("String value \"" + name + "\" required, but not specified");	//[JOJO]
	...
	public <T extends Enum<T>> T getEnum(String name, Class<T> enumClass)
	{
		...
		if (val == null)
		{
			throw new IllegalArgumentException("getEnum(\"" + name + "\"," + enumClass.getSimpleName() + "):  <set name=\"" + name + "\" val=\"...\" /> の記述が無い。" + dump());
		...
		{
			throw new IllegalArgumentException("getEnum(\"" + name + "\"," + enumClass.getSimpleName() + "):  <set name=\"" + name + "\" val=\"" + val + "\" /> の" + val + "は無効な値。" + dump());
	...
	public <T extends Enum<T>> T getEnum(String name, Class<T> enumClass, T deflt)
	{
		...
		{
			throw new IllegalArgumentException("getEnum(\"" + name + "\"," + enumClass.getSimpleName() + "," + deflt.name() + "):  <set name=\"" + name + "\" val=\"" + val + "\" /> の" + val + "は無効な値。" + dump());
		//	throw new IllegalArgumentException("Enum value of type " + enumClass.getName() + " required, but found: " + val);
		}
	}
