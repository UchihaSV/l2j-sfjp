...
public class ClanHall
{
	...
	public ClanHall(int clanHallId, String name, int ownerId, int lease, String desc, String location/*[JOJO]*/, String locName, long paidUntil, int Grade,
			boolean paid)
	{
	...
	public final GregorianCalendar getPaidTomorrow()
	{
		...
		cal.setTimeInMillis(_paidUntil + _chRate);
		return cal;
	}
	//-------------------------------------------------------
			...
			try
			{
				...
				else
				{
					...
					else
					{
						...
						//[JOJO]-------------------------------------------------
						sm.addNumber(getPaidTomorrow().get(GregorianCalendar.HOUR_OF_DAY));
