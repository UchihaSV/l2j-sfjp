...
public class Quest extends ManagedScript implements IIdentifiable
{
	...
	{
		return showHtmlFile(player, filename, null, !filename.endsWith(".html"));
	}
	...
	{
		return showHtmlFile(player, filename, npc, !filename.endsWith(".html"));
	}
	 ...
	 * @see #showHtmlFile(L2PcInstance, String, L2Npc)
	 */
	public String showHtmlFile(L2PcInstance player, String filename, L2Npc npc, boolean questwindow)	//[JOJO]
	{
		int questId = getId();
