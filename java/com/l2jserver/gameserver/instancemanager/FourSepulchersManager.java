 ...
 //	protected TIntObjectHashMap<L2Spawn> _keyBoxSpawns = new TIntObjectHashMap<L2Spawn>();		//-[JOJO]
	...
	public void managerSay(byte min)
	{
		...
		if (_inAttackTime)
		{
			...
			String msg = /*TODO:1000455*/"Œ»Ý" + min + /*TODO:1000456*/"•ª‚ªŒo‰ß‚µ‚Ü‚µ‚½"; // now this is a
		//	String msg = min + " minute(s) have passed."; // now this is a
			// proper message^^
			
			if (min == 90)
				msg = /*TODO:1000457*/"ƒQ[ƒ€‚ªI—¹‚µ‚Ü‚µ‚½BŠÔ‚à‚È‚­Ž©“®ƒeƒŒƒ|[ƒg‚µ‚Ü‚·B";
		...
		else if (_inEntryTime)
		{
			...
			final int msg2 = 1000501; //"Žl‘å—ì•_‚ÌÎ‘œ‚ÉŽè‚ðæ‚¹‚é‚Æ—ì•_“à‚É“ü‚é‚±‚Æ‚ª‚Å‚«‚Ü‚·B"
