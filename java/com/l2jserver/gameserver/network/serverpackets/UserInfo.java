...
public final class UserInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		for (L2CubicInstance cubic : _activeChar.getCubics().values())
		{
			writeH(cubic.getId());
		}
		...
		writeC(_activeChar.isHero() || (Config.GM_HERO_AURA && _activeChar.isGM()) || (Config.MOD_AURA && _activeChar.aura) ? 1 : 0); // 0x01: Hero Aura //[JOJO]
