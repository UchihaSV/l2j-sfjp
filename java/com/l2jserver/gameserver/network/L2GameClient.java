...
public final class L2GameClient extends MMOClient<MMOConnection<L2GameClient>> implements Runnable
{
	...
	public L2GameClient(MMOConnection<L2GameClient> con)
	{
		...
		{
			_autoSaveInDB = ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new AutoSaveTask(), Rnd.get(300000L, 300000L + Config.CHAR_STORE_INTERVAL * 60000L), (Config.CHAR_STORE_INTERVAL * 60000L));	//[JOJO]
