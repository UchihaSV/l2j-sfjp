					...
					if ("option".equalsIgnoreCase(d.getNodeName()))
					{
						...
						for (Node cd = d.getFirstChild(); cd != null; cd = cd.getNextSibling())
						{
							switch (cd.getNodeName())
							{
								...
								case "active_skill":
								{
									op.setActiveSkill(parseInteger(cd.getAttributes(), "id"), parseInteger(cd.getAttributes(), "level"));
									break;
								}
								case "passive_skill":
								{
									op.setPassiveSkill(parseInteger(cd.getAttributes(), "id"), parseInteger(cd.getAttributes(), "level"));
									break;
								}
								case "attack_skill":
								{
