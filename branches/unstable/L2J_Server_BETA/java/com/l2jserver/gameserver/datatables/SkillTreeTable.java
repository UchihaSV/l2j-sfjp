...
public class SkillTreeTable
{
    ...
    // [L2J_JP ADD][JOJO]
    /*
     * NOTE:Max skill learning cost = (skillCost + _addCrossLearn) * _mulCrossLearn * _mulCrossLearnRace * _mulCrossLearnProf
     * ex) AntiMagic Lv1 -> (240 + 1000) * 2 * 2 * 3 = 14880
     * Details -> read L2Skill Constructor
     */
	public int getSkillCost(L2PcInstance player, L2Skill skill)
	{
		ClassId classId = player.getSkillLearningClassId();
		return getSkillCost(player, skill, classId);
	}
	public int getSkillCost(L2PcInstance player, L2Skill skill, ClassId classId)
	{
		int skillCost = 100000000;
		if (classId == null) return skillCost;				//+[JOJO]
//		ClassId classId = player.getSkillLearningClassId();	//-[JOJO]
