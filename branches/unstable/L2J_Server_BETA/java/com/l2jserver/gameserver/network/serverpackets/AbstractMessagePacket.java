...
public abstract class AbstractMessagePacket<T extends AbstractMessagePacket<?>> extends L2GameServerPacket
{
	...
	private final T append(final SMParam param)
	{
	...
	public final T addCastleName(final com.l2jserver.gameserver.model.entity.Castle castle)
	{
		return addCastleName(castle.getCastleId());	//1-9 Castle names
	}
	public final T addClanHallName(final com.l2jserver.gameserver.model.entity.ClanHall clanHall)
	{
		return addCastleName(clanHall.getId());	//21-64 Clan Hall names
	}
	public final T addSiegableHallName(final com.l2jserver.gameserver.model.entity.clanhall.SiegableHall siegableHall)
	{
		return addCastleName(siegableHall.getId());	//21,34,35,62,63,64 Siegable Clanhall names
	}
	public final T addTerritoryName(final com.l2jserver.gameserver.instancemanager.TerritoryWarManager.Territory territory)
	{
		return addCastleName(territory.getTerritoryId());	//81-89 Territory names
	}
	public final T addFortName(final com.l2jserver.gameserver.model.entity.Fort fort)
	{
		return addCastleName(fort.getFortId());	//101-121 Fortress names
	}
	private final T addCastleName(final int number)
	{
	...
	public T addNumber(final long number)
	{
	...
	public final T addItemNumber(final int number)
	{
	...
	{
		return append(new SMParam(TYPE_DOOR_NAME, doorId));
	}
	...
	public final T addItemName(final L2ItemInstance item)
	{
		return addItemName(item.getItem());
	}
	
	public final T addItemName(final L2Item item)
	{
		int id = item.getId();
	...
	public final T getLocalizedMessage(final String lang)
	{
		...
		return addString(sml.getLocalisation(params));
	}
}
