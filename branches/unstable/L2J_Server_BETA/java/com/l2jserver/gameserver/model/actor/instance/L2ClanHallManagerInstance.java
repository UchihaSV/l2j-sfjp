...
public class L2ClanHallManagerInstance extends L2MerchantInstance
{
			...
			else if (actualCommand.equalsIgnoreCase("manage_vault"))
			{
				...
				if (player.hasClanPrivilege(L2Clan.CP_CL_VIEW_WAREHOUSE))
				{
					...
					else
					{
						...
						html.replace("%rent%", formatAdena(getClanHall().getLease()));
					...
					if (val.equalsIgnoreCase("recovery"))
					{
						if (st.countTokens() >= 1)
						{
							...
							else if (val.equalsIgnoreCase("edit_hp"))
							{
								...
								html.replace("%cost%", formatAdena(cost) + "</font>Adena /" + (Config.CH_HPREG_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_mp"))
							{
								...
								html.replace("%cost%", formatAdena(cost) + "</font>Adena /" + (Config.CH_MPREG_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_exp"))
							{
								...
								html.replace("%cost%", formatAdena(cost) + "</font>Adena /" + (Config.CH_EXPREG_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
					...
					else if (val.equalsIgnoreCase("other"))
					{
						if (st.countTokens() >= 1)
						{
							...
							else if (val.equalsIgnoreCase("edit_item"))
							{
								...
								html.replace("%cost%", formatAdena(cost) + "</font>Adena /" + (Config.CH_ITEM_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_support"))
							{
								...
								html.replace("%cost%", formatAdena(cost) + "</font>Adena /" + (Config.CH_SUPPORT_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_tele"))
							{
								...
								html.replace("%cost%", formatAdena(cost) + "</font>Adena /" + (Config.CH_TELE_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
					...
					else if (val.equalsIgnoreCase("deco") && !getClanHall().isSiegableHall())
					{
						if (st.countTokens() >= 1)
						{
							...
							else if (val.equalsIgnoreCase("edit_curtains"))
							{
								...
								html.replace("%cost%", formatAdena(cost) + "</font>Adena /" + (Config.CH_CURTAIN_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_fixtures"))
							{
								...
								html.replace("%cost%", formatAdena(cost) + "</font>Adena /" + (Config.CH_FRONT_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day</font>)");
				...
				try
				{
					...
					try
					{
						...
						else
						{
							...
							if (Config.CH_BUFF_FREE || (getCurrentMp() >= skill.getMpConsume() + skill.getMpInitialConsume()))
							{
								doCast(skill);
							}
							else
	...
	public void showChatWindow(L2PcInstance player)
	{
		...
		if (condition == COND_OWNER)
		{
			content = HtmCache.getInstance().getHtm(player.getHtmlPrefix(), "data/html/clanHallManager/chamberlain-" + getId() + ".htm");
			if (content == null)
			{
