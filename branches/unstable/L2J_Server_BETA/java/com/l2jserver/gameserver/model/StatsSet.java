...
public class StatsSet implements IParserAdvUtils
{
	...
	public String getString(String key)
	{
		...
		if (val == null)
		{
			throw new IllegalArgumentException("String value \"" + key + "\" required, but not specified");	//[JOJO]
	...
	public <T extends Enum<T>> T getEnum(String key, Class<T> enumClass)
	{
		...
		if (val == null)
		{
			throw new IllegalArgumentException("getEnum(\"" + key + "\"," + enumClass.getSimpleName() + "):  <set name=\"" + key + "\" val=\"...\" /> の記述が無い。" + dump());
		...
		{
			throw new IllegalArgumentException("getEnum(\"" + key + "\"," + enumClass.getSimpleName() + "):  <set name=\"" + key + "\" val=\"" + val + "\" /> の" + val + "は無効な値。" + dump());
		//	throw new IllegalArgumentException("Enum value of type " + enumClass.getName() + " required, but found: " + val);
		}
	}
	
	private String dump()	//[JOJO]
	{
		if (_set.size() == 0) return "";
		StringBuilder sb = new StringBuilder(256).append("\n _set = {\n");
		for (Map.Entry<String, Object> i : _set.entrySet())
	...
	public <T extends Enum<T>> T getEnum(String key, Class<T> enumClass, T defaultValue)
	{
		...
		{
			throw new IllegalArgumentException("getEnum(\"" + key + "\"," + enumClass.getSimpleName() + "," + defaultValue.name() + "):  <set name=\"" + key + "\" val=\"" + val + "\" /> の" + val + "は無効な値。" + dump());
		//	throw new IllegalArgumentException("Enum value of type " + enumClass.getName() + " required, but found: " + val);
		}
	}
