			...
			else if (actualCommand.equalsIgnoreCase("manage"))
			{
				if ((player.getClanPrivileges() & L2Clan.CP_CS_SET_FUNCTIONS) == L2Clan.CP_CS_SET_FUNCTIONS)
				{
					if (val.equalsIgnoreCase("recovery"))
					{
						...
						if (getCastle().getFunction(Castle.FUNC_RESTORE_HP) != null)
						{
							html.replace("%hp_recovery%", getCastle().getFunction(Castle.FUNC_RESTORE_HP).getLvl()
									+ "%</font> (<font color=\"FFAABB\">"
									+ getCastle().getFunction(Castle.FUNC_RESTORE_HP).getLease()
									+ "</font>Adena /"
									+ (Config.CS_HPREG_FEE_RATIO
											/ 1000 / 60 / 60 / 24) + " Day)");
						...
						if (getCastle().getFunction(Castle.FUNC_RESTORE_EXP) != null)
						{
							html.replace("%exp_recovery%", getCastle().getFunction(Castle.FUNC_RESTORE_EXP).getLvl()
									+ "%</font> (<font color=\"FFAABB\">"
						...
						if (getCastle().getFunction(Castle.FUNC_RESTORE_MP) != null)
						{
							html.replace("%mp_recovery%", getCastle().getFunction(Castle.FUNC_RESTORE_MP).getLvl()
									+ "%</font> (<font color=\"FFAABB\">"
									+ getCastle().getFunction(Castle.FUNC_RESTORE_MP).getLease()
									+ "</font>Adena /"
									+ (Config.CS_MPREG_FEE_RATIO
											/ 1000 / 60 / 60 / 24) + " Day)");
					...
					else if (val.equalsIgnoreCase("other"))
					{
						...
						if (getCastle().getFunction(Castle.FUNC_TELEPORT) != null)
						{
							html.replace("%tele%", "Stage "
									...
									+ "</font> (<font color=\"FFAABB\">"
									+ getCastle().getFunction(Castle.FUNC_TELEPORT).getLease()
									+ "</font>Adena /"
									+ (Config.CS_TELE_FEE_RATIO
											/ 1000 / 60 / 60 / 24) + " Day)");
						...
						if (getCastle().getFunction(Castle.FUNC_SUPPORT) != null)
						{
							html.replace("%support%", "Stage "
									...
									+ "</font> (<font color=\"FFAABB\">"
									+ getCastle().getFunction(Castle.FUNC_SUPPORT).getLease()
									+ "</font>Adena /"
									+ (Config.CS_SUPPORT_FEE_RATIO
											/ 1000 / 60 / 60 / 24) + " Day)");
