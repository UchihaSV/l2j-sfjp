...
public abstract class L2Character extends L2Object implements ISkillsHolder, IDeletable
{
	...
	private boolean _isFallsdown; // [L2J_JP ADD]
	...
	private final IntObjectMap<Skill> _skills;	//[JOJO] -FastMap<Integer, Skill>().shared()
	...
	private int _castEndTime; //[L2J_JP]
	...
	public L2Character(int objectId, L2CharTemplate template)
	{
		...
		else if (isNpc())
		{
			...
			_skills = new FastIntObjectMap<Skill>().shared();
	...
	private void beginCast(Skill skill, boolean simultaneously, L2Character target, L2Object[] targets)
	{
		...
		if (isPlayable())
		{
			if (skill.getItemConsumeId() > 0)
			{
				...
				{
					getActingPlayer().sendPacket(SystemMessageId.NOT_ENOUGH_REQUIRED_ITEMS);
					abortCast();
					return;
				}
			}
	...
	//	if (!skill.isPotion() && isPlayer() && magicId != 1312) //[L2J_JP EDIT - TSL]	//[JOJO]r5394廃止
	...
	public final boolean isFallsdown() // [L2J_JP]
	{
		return _isFallsdown;
	}
	
	public final void setIsFallsdown(boolean value) // [L2J_JP]
	{
		_isFallsdown = value;
	}
			...
			if (getAttackByList() != null && getAttackByList().size() != 0)
			{
				...
				else
				{
					...
					switch (_diff)
					{
						...
						case 4:
						case 5:
							if (Rnd.get(100) < 5) //fails at 5%.
								isFakeDeath = false;
							break;
						case 6:
							if (Rnd.get(100) < 10) //fails at 10%.
								isFakeDeath = false;
							break;
						case 7:
							if (Rnd.get(100) < 15) //fails at 15%.
								isFakeDeath = false;
							break;
						case 8:
							if (Rnd.get(100) < 20) //fails at 20%.
								isFakeDeath = false;
							break;
						case 9:
	...
	//[JOJO] L2J_Server_BETA r6249 / L2J_DataPack_BETA r9994 移行用
	/*@Deprecated*/ public final AbstractEffect/*L2Effect*/ getFirstEffect(Skill skill)
	{
	...
	{
		return _skills.size() == 0 ? Collections.<Skill>emptyList() : new ArrayList<>(_skills.values());
	}
	...
	{
		return false;	//[JOJO] L2Character から L2PcInstance へ引越し.
	}
...
// L2J r2884:
//  svn move 
//   java\net\sf\l2j\gameserver\model\L2Character.java
