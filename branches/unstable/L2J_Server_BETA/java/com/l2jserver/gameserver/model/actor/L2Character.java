...
public abstract class L2Character extends L2Object
{
	...
	private void beginCast(L2Skill skill, boolean simultaneously, L2Character target, L2Object[] targets)
	{
		...
		if (!skill.isPotion() && this instanceof L2PcInstance && magicId != 1312)	//[L2J_JP EDIT - TSL]
	...
	public boolean isAttackingDisabled() { return isFlying() || isStunned() || isSleeping() || _attackEndTime > GameTimeController.getGameTicks() || isAlikeDead() || isParalyzed() || isPhysicalAttackMuted() || isCoreAIDisabled() /*[L2J_JP]*/|| isFallsdown()/**/; }
	...
	public final boolean isFallsdown() { return _isFallsdown; }	// [L2J_JP]
	public final void setIsFallsdown(boolean value) { _isFallsdown = value; }	// [L2J_JP]
	...
	public final int getAbnormalEffects() { return _AbnormalEffects; }	//+[JOJO]
	...
	public long getCastEndTimeLeftMilli()
	{
		if (isCastingNow())
		{
			...
			if (t > 0) return (long)t * GameTimeController.MILLIS_IN_TICK;
		}
		return 0L;
	}
