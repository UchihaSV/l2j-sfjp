...
public class ShortCuts implements IRestorable
{
	...
	private final FastIntObjectMap<Shortcut> _shortCuts = new FastIntObjectMap<>();	//[JOJO] -TreeMap
	...
	{
		return _shortCuts.values();	//[JOJO] -_shortCuts.values().toArray(new Shortcut[_shortCuts.values().size()])
	}
