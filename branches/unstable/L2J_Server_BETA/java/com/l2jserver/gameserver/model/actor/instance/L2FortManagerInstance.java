			...
			else if (actualCommand.equalsIgnoreCase("functions"))
			{
				...
				else
				{
					...
					if (getFort().getFunction(Fort.FUNC_RESTORE_EXP) != null)
						html.replace("%xp_regen%", getFort().getFunction(Fort.FUNC_RESTORE_EXP).getLvl());
					else
						html.replace("%xp_regen%", "0");
					if (getFort().getFunction(Fort.FUNC_RESTORE_HP) != null)
						html.replace("%hp_regen%", getFort().getFunction(Fort.FUNC_RESTORE_HP).getLvl());
					else
						html.replace("%hp_regen%", "0");
					if (getFort().getFunction(Fort.FUNC_RESTORE_MP) != null)
						html.replace("%mp_regen%", getFort().getFunction(Fort.FUNC_RESTORE_MP).getLvl());
					else
			...
			else if (actualCommand.equalsIgnoreCase("manage"))
			{
				if ((player.getClanPrivileges() & L2Clan.CP_CS_SET_FUNCTIONS) == L2Clan.CP_CS_SET_FUNCTIONS)
				{
					if (val.equalsIgnoreCase("recovery"))
					{
						...
						if (getFort().getFunction(Fort.FUNC_RESTORE_HP) != null)
						{
							html.replace("%hp_recovery%", getFort().getFunction(Fort.FUNC_RESTORE_HP).getLvl()
									+ "%</font> (<font color=\"FFAABB\">"
									+ getFort().getFunction(Fort.FUNC_RESTORE_HP).getLease()
									+ "</font>Adena /"
									+ (Config.FS_HPREG_FEE_RATIO
											/ 1000 / 60 / 60 / 24) + " Day)");
						...
						if (getFort().getFunction(Fort.FUNC_RESTORE_EXP) != null)
						{
							html.replace("%exp_recovery%", getFort().getFunction(Fort.FUNC_RESTORE_EXP).getLvl()
									+ "%</font> (<font color=\"FFAABB\">"
									+ getFort().getFunction(Fort.FUNC_RESTORE_EXP).getLease()
									+ "</font>Adena /"
									+ (Config.FS_EXPREG_FEE_RATIO
											/ 1000 / 60 / 60 / 24) + " Day)");
						...
						if (getFort().getFunction(Fort.FUNC_RESTORE_MP) != null)
						{
							html.replace("%mp_recovery%", getFort().getFunction(Fort.FUNC_RESTORE_MP).getLvl()
									+ "%</font> (<font color=\"FFAABB\">"
									+ getFort().getFunction(Fort.FUNC_RESTORE_MP).getLease()
									+ "</font>Adena /"
									+ (Config.FS_MPREG_FEE_RATIO
											/ 1000 / 60 / 60 / 24) + " Day)");
					...
					else if (val.equalsIgnoreCase("other"))
					{
						...
						if (getFort().getFunction(Fort.FUNC_TELEPORT) != null)
						{
							html.replace("%tele%", "Stage "
									+ getFort().getFunction(Fort.FUNC_TELEPORT).getLvl()
									+ "</font> (<font color=\"FFAABB\">"
									+ getFort().getFunction(Fort.FUNC_TELEPORT).getLease()
									+ "</font>Adena /"
									+ (Config.FS_TELE_FEE_RATIO
											/ 1000 / 60 / 60 / 24) + " Day)");
						...
						if (getFort().getFunction(Fort.FUNC_SUPPORT) != null)
						{
							html.replace("%support%", "Stage "
									+ getFort().getFunction(Fort.FUNC_SUPPORT).getLvl()
									+ "</font> (<font color=\"FFAABB\">"
									+ getFort().getFunction(Fort.FUNC_SUPPORT).getLease()
									+ "</font>Adena /"
									+ (Config.FS_SUPPORT_FEE_RATIO
											/ 1000 / 60 / 60 / 24) + " Day)");
