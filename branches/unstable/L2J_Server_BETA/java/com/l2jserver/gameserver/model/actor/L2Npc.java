...
if (com.l2jserver.Config.NEVER_RandomAnimation_IF_DEAD) {
	...
	{
		return (hasAIValue("aggroRange") ? getAIValue("aggroRange") : _staticAIData.getAggroRange()) & _aggroMask;	//+[JOJO];//-[JOJO]
	//	return hasAIValue("aggroRange") ? getAIValue("aggroRange") : _staticAIData.getAggroRange();//-[JOJO]
	}
