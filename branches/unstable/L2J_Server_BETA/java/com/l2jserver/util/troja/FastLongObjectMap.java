...
public class FastLongObjectMap <V>  implements LongObjectMap<V>, Reusable,
    ...
    private static final long KEY_NULL = 0;
     ...
     */
    private transient FastLongObjectMap[] _subMaps;
    /**
...
//    private transient KeySet _keySet;
     ...
     */
    private transient LongObjectMap <V>  _unmodifiable;
//    /**
...
//    private transient boolean _isDirectKeyComparator;
     ...
     */
    public FastLongObjectMap(String id) {
...
//        };
     ...
     */
    public FastLongObjectMap(int capacity) {
     ...
     */
    public FastLongObjectMap(LongObjectMap <? extends V>  map) {
        this(map.size());
        putAll(map);
    }
    public FastLongObjectMap(TLongObjectMap  <? extends V>  map) {
        this(map.size());
        putAll(map);
    }
    public FastLongObjectMap(java.util.Map <Long, ? extends V>  map) {
        this(map.size());
        putAll(map);
    }
     ...
     */
    private FastLongObjectMap(Entry[] entries) {
        _entries = entries;
    }
     ...
     */
    public static <V>  FastLongObjectMap <V>  newInstance() {
        return (FastLongObjectMap <V> ) FACTORY.object();
    }
     ...
     */
    public static void recycle(FastLongObjectMap instance) {
     ...
     *         this map's key.
     */
    public final Map <V,Long>  reverse() {
        FastMap <V,Long>  map = new FastMap<V,Long>(FastLongObjectMap.this.size());	//TODO:
    ...
    /**
     * Returns the number of key-value mappings in this {@link FastLongObjectMap}.
     * 
    ...
    public final Entry <V>  getEntry(long key) {
        return getEntry(key, (int)(key ^ (key >>> 32)));
    }

    private final Entry getEntry(long key, int keyHash) {
        final FastLongObjectMap map = getSubMap(keyHash);
    ...
    private final FastLongObjectMap getSubMap(int keyHash) {
    ...
    public final  V  put( long  key,  V  value) {
        return ( V ) put(key, value, (int)(key ^ (key >>> 32)), _isShared, false,
                false);
    }

    private final Object put(long key, Object value, int keyHash,
...
if (REENTRANT_LOCK) {{
            ...
            public void run() {
                ...
                if (nullCount > _entryCount) { // Yes.
                    if (isShared) { // Replaces with a new table.
                        ...
                        FastLongObjectMap.reset(_entries); // Ok not shared. 
                        copyEntries(tmp, _entries, _entries.length);
                        FastLongObjectMap.reset(tmp); // Clear references.
                ...
                for (int i = 0; i < _entries.length;) {
                    ...
                    FastLongObjectMap subMap = _subMaps[(entry._keyHash >> _keyShift) & (C2 - 1)];
                ...
                if(isShared) {
                    ...
                    FastLongObjectMap.reset(_entries);
                    _nullCount = 0;
                    _entryCount = 0;
                }
    ...
    private FastLongObjectMap[] newSubMaps(int capacity) {
        FastLongObjectMap[] subMaps = new FastLongObjectMap[C2];
        for (int i = 0; i < C2; i++) {
            FastLongObjectMap subMap = new FastLongObjectMap(new Entry[capacity]);
     ...
     * @throws NullPointerException if the key is <code>null</code>.
     */
    public final Entry <V>  putEntry( long  key,  V  value) {
        return (Entry <V> ) put(key, value, (int)(key ^ (key >>> 32)), _isShared, false,
                true);
    }
     ...
     */
    public final void putAll(LongObjectMap <? extends V>  map) {
        for (Iterator i = map.entrySet().iterator(); i.hasNext();) {
            LongObjectMap.Entry <V>  e = (LongObjectMap.Entry <V> ) i.next();
            put(e.getKey(), e.getValue());
        }
    }
    public final void putAll(TLongObjectMap <? extends V>  map) {
        map.forEachEntry(new TLongObjectProcedure<V>(){
            @Override
            public boolean execute(long key, V value) {
                FastLongObjectMap.this.put(key, value);
                return true;
            }
        });
    }
    public final void putAll(java.util.Map <Long, ? extends V>  map) {
        for (Iterator i = map.entrySet().iterator(); i.hasNext();) {
            java.util.Map.Entry <Long,V>  e = (java.util.Map.Entry <Long,V> ) i.next();
     ...
     * @throws NullPointerException if the key is <code>null</code>.
     */
    public final  V  putIfAbsent( long  key,
             V  value) {
        return ( V ) put(key, value, (int)(key ^ (key >>> 32)), _isShared, true,
                false);
    }
    ...
    public final  V  remove(long key) {
        return ( V ) remove(key, (int)(key ^ (key >>> 32)), _isShared);
    }

    private final Object remove(long key, int keyHash, boolean concurrent) {
        final FastLongObjectMap map = getSubMap(keyHash);
        final Entry[] entries = map._entries; // Atomic.
        final int mask = entries.length - 1;
        for (int i = keyHash >> map._keyShift;; i++) {
...
if (REENTRANT_LOCK) {{
     ...
     */
    public FastLongObjectMap <V>  shared() {
...
//     */
//    public FastLongObjectMap <V>  setShared(boolean isShared) {
...
//    }
     ...
     * @return <code>this</code>
     */
    public FastLongObjectMap <V>  setValueComparator(
    ...
    public boolean equals(Object obj) {
        if (obj == this) {
            ...
            LongObjectMap <?>  that = (LongObjectMap) obj;
    ...
    public final long[] keys() {
        long[] array = new long[FastLongObjectMap.this.size()];
        int length = 0;
     ...
     * trove like.
     */
    public boolean retainEntries(LongObjectProcedure<? super V> procedure) {
        boolean modified = false;
        for (Iterator<LongObjectMap.Entry<V>> it = entrySet().iterator(); it.hasNext(); ) {
            LongObjectMap.Entry<V> e = it.next();
    ...
    public final Collection <V>  valueCollection() {
        return values();
    }
    ...
    private final class Values extends FastCollection {
        ...
        public int size() {
            return FastLongObjectMap.this.size();
        }

        public void clear() {
            FastLongObjectMap.this.clear();
        }

        public Record head() {
            return FastLongObjectMap.this._head;
        }

        public Record tail() {
            return FastLongObjectMap.this._tail;
        }
        ...
        public void delete(Record record) {
            FastLongObjectMap.this.remove(((Entry) record).getKey());
        }
        ...
        public Iterator iterator() {
            return ValueIterator.valueOf(FastLongObjectMap.this);
        }
    }
    ...
    private static final class ValueIterator implements Iterator {
        ...
        private FastLongObjectMap _map;
        private Entry _current;
        private Entry _next;
        private Entry _tail;

        public static ValueIterator valueOf(FastLongObjectMap map) {
     ...
     * <code>LongObjectMap.Entry</code>. The collection is backed by the map, so
     ...
     *         (instance of {@link FastCollection}).
     */
    public final Set <LongObjectMap.Entry<V>>  entrySet() {
        if (_entrySet == null) {
            MemoryArea.getMemoryArea(this).executeInArea(new Runnable() {
    ...
    private final class EntrySet extends FastCollection implements Set {
        ...
        public boolean contains(Object obj) { // Optimization.
            if (obj instanceof LongObjectMap.Entry) {
                LongObjectMap.Entry thatEntry = (LongObjectMap.Entry) obj;
        ...
        public Object valueOf(Record record) {
            return (LongObjectMap.Entry) record;
        }
        ...
        private final FastComparator _entryComparator = new FastComparator() {
            ...
            public boolean areEqual(Object o1, Object o2) {
                if ((o1 instanceof LongObjectMap.Entry) && (o2 instanceof LongObjectMap.Entry)) {
                    LongObjectMap.Entry e1 = (LongObjectMap.Entry) o1;
                    LongObjectMap.Entry e2 = (LongObjectMap.Entry) o2;
            ...
            public int compare(Object o1, Object o2) {
                if ((o1 instanceof LongObjectMap.Entry) && (o2 instanceof LongObjectMap.Entry)) {
                    LongObjectMap.Entry e1 = (LongObjectMap.Entry) o1;
                    LongObjectMap.Entry e2 = (LongObjectMap.Entry) o2;
                    long a = e1.getKey() - e2.getKey(); return a < 0 ? -1 : a > 0 ? 1 : 0;
                }
            ...
            public int hashCodeOf(Object obj) {
                LongObjectMap.Entry entry = (LongObjectMap.Entry) obj;
                return entry.getKeyHash() + _valueComparator.hashCodeOf(entry.getValue());
            }
        };

        public Iterator iterator() {
            return EntryIterator.valueOf(FastLongObjectMap.this);
        }
    }
    ...
    private static final class EntryIterator implements Iterator {
        ...
        public static EntryIterator valueOf(FastLongObjectMap map) {
...
//    }
    ...
    /**
     * <pre>For example:
     * for (LongIterator it = map.keySetIterator(); it.hasNext(); ) {
     *   long key = it.next();
     *   ...
     * }</pre>
     */
    public LongIterator keySetIterator() {
        return KeyIterator.valueOf(FastLongObjectMap.this);
    }
    // Entry iterator optimization.
    private static final class KeyIterator implements LongIterator {
        ...
        public static KeyIterator valueOf(FastLongObjectMap map) {
     ...
     */
    public final LongObjectMap <V>  unmodifiable() {
    ...
    private void readObject(ObjectInputStream stream) throws IOException,
        ...
        for (int i = 0; i < size; i++) {
             long  key = ( long ) stream.readObject();
    ...
    /**
     * This class represents a {@link FastLongObjectMap} entry.
     * Custom {@link FastLongObjectMap} may use a derived implementation.
     * For example:[code]
     *    static class MyMap<K,V,X> extends LongObjectMap<V> {
     ...
     *    }[/code]
     */
    public static class Entry <V>  implements LongObjectMap.Entry <V> , Record, Realtime {
        ...
        public boolean equals(Object that) {
            if (that instanceof LongObjectMap.Entry) {
                LongObjectMap.Entry entry = (LongObjectMap.Entry) that;
         ...
         */
        public int hashCode() {
            return (int)(_key ^ (_key >>> 32)) ^ ((_value != null) ? _value.hashCode() : 0);
    ...
    /**
     * This class represents an read-only view over a {@link FastLongObjectMap}.
     */
    private final class Unmodifiable implements LongObjectMap, Serializable {

        public boolean equals(Object obj) {
            return FastLongObjectMap.this.equals(obj);
        }

        public int hashCode() {
            return FastLongObjectMap.this.hashCode();
        }

        public Text toText() {
            return FastLongObjectMap.this.toText();
        }
        ...
        public boolean isEmpty() {
            return FastLongObjectMap.this.isEmpty();
        }

        public boolean containsKey(long key) {
            return FastLongObjectMap.this.containsKey(key);
        }

        public boolean containsValue(Object value) {
            return FastLongObjectMap.this.containsValue(value);
        }

        public Object get(long key) {
            return FastLongObjectMap.this.get(key);
        }
        ...
        public long[] keys() {
            return FastLongObjectMap.this.keys();
        }

        public LongIterator keySetIterator() { throw new UnsupportedOperationException(); } //TODO:

        public Collection values() {
            return ((Values) FastLongObjectMap.this.values()).unmodifiable();
        }
        ...
        public boolean forEachKey(LongProcedure procedure) { throw new UnsupportedOperationException(); } //TODO:
        public boolean forEachValue(ObjectProcedure procedure) { throw new UnsupportedOperationException(); } //TODO:
        public boolean forEachEntry(LongObjectProcedure procedure) { throw new UnsupportedOperationException(); } //TODO:
    }
