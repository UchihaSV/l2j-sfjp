...
//    }
     ...
     * trove like.
     */
    public boolean retainEntries(IntObjectProcedure<? super V> procedure) {
        boolean modified = false;
        for (Iterator<IntObjectMap.Entry<V>> it = entrySet().iterator(); it.hasNext(); ) {
            IntObjectMap.Entry<V> e = it.next();
